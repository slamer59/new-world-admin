...
DB_CONTAINER_NAME="new-world-admin-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=new-world-admin -d -p 5432:5432 docker.io/postgres
